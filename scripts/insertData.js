...
//   try {
//     // Read JSON data
//     const jsonData = fs.readFileSync(path.join(__dirname, 'data', fileName), 'utf-8');
...
// Read JSON data
const jsonData = fs.readFileSync(path.join(__dirname, 'data', 'modified_vegetarian_recipes.json'), 'utf-8')
const recipesData = JSON.parse(jsonData)
